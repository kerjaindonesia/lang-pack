...
/**
 * Strings for component 'data', language 'id', version '3.9'.
 *
 * @package     data
 * @category    string
...
$string['addtemplate'] = 'Tambahkan templat';
...
$string['areacontent'] = 'Ruas';
$string['ascending'] = 'Naik';
...
$string['authorfirstname'] = 'Nama depan penulis';
$string['authorlastname'] = 'nama keluarga penulis';
...
$string['cannotdeletepreset'] = 'Kesalahan saat menghapus preset!';
...
$string['chooseexportfields'] = 'Pilih ruas yang akan Anda ekspor';
...
$string['completionentriescount'] = 'Jumlah entri';
...
$string['confirmdeletefield'] = 'Anda akan menghapus ruas ini, apakah Anda yakin?';
...
$string['csstemplate'] = 'Templat CSS';
$string['csvfailed'] = 'Tidak dapat membaca data mentah dari berkas CSV';
$string['csvfile'] = 'Berkas CSV';
$string['csvimport'] = 'Impor berkas CSV';
$string['csvimport_help'] = 'Entri dapat diimpor melalui berkas teks biasa dengan daftar nama ruas sebagai baris pertama, kemudian data, dengan satu data per baris.';
...
$string['defaultsortfield'] = 'Ruas pengurutan bawaan';
...
$string['entrieslefttoadd'] = 'Anda harus menambahkan {$ a-> entriesleft} lebih banyak entri / entri untuk menyelesaikan aktivitas ini';
...
$string['errorpresetexists'] = 'Sudah ada preset dengan nama yang dipilih';
$string['eventfieldcreated'] = 'Membuat ruas';
$string['eventfielddeleted'] = 'Menghapus ruas';
$string['eventfieldupdated'] = 'Memperbarui ruas';
...
$string['exportaszip_help'] = 'Fitur ekspor sebagai zip memungkinkan Anda untuk menyimpan templat dan ruas sebagai zip yang telah ditetapkan untuk diunduh. Zip kemudian dapat diimpor ke kursus lain.';
...
$string['failedpresetdelete'] = 'Galat saat menghapus preset!';
$string['fieldadded'] = 'Ruas ditambahkan';
$string['fieldallowautolink'] = 'Izinkan tautan otomatis';
$string['fielddeleted'] = 'Ruas dihapus';
$string['fielddelimiter'] = 'Pembatas ruas';
$string['fielddescription'] = 'Deskripsi ruas';
$string['fieldenclosure'] = 'Penutup ruas';
$string['fieldheight'] = 'Tinggi';
$string['fieldheightlistview'] = 'Tinggi dalam tampilan daftar';
$string['fieldheightsingleview'] = 'Tinggi dalam tampilan tunggal';
$string['fieldids'] = 'ID ruas';
$string['fieldmappings'] = 'Pemetaan ruas';
...
$string['fieldnotmatched'] = 'Ruas berikut dalam file berkas tidak dikenal dalam basis data ini: {$a}';
$string['fieldoptions'] = 'Opsi (satu per baris)';
$string['fields'] = 'Bidang';
$string['fieldupdated'] = 'Ruas diperbarui';
$string['fieldwidth'] = 'Lebar';
$string['fieldwidthlistview'] = 'Lebar dalam tampilan daftar';
$string['fieldwidthsingleview'] = 'Lebar dalam tampilan tunggal';
$string['file'] = 'Berkas';
...
$string['foundnorecords'] = 'Tidak ada rekaman yang ditemukan (<a href="{$a->reseturl}">Setel ulang filter</a>)';
$string['foundrecords'] = 'Catatan yang ditemukan: {$ a-> num} / {$ a-> maks} (<a href="{$a-> reseturl} "> Setel ulang filter </a>)';
$string['fromfile'] = 'Impor dari berkas zip';
$string['fromfile_help'] = 'Fitur impor dari berkas zip memungkinkan Anda menelusuri dan mengunggah zip templat dan ruas yang telah ditetapkan sebelumnya.';
$string['generateerror'] = 'Tidak semua berkas dihasilkan!';
$string['header'] = 'Tajuk';
$string['headeraddtemplate'] = 'Mendefinisikan antarmuka untuk menambahkan atau mengedit entri';
$string['headerasearchtemplate'] = 'Mendefinisikan antarmuka untuk pencarian lanjutan';
$string['headercsstemplate'] = 'Mendefinisikan gaya CSS lokal untuk templat lainnya';
$string['headerjstemplate'] = 'Mendefinisikan Javascript tersuai untuk memanipulasi cara elemen ditampilkan dalam Daftar, Tunggal atau Tambah templat';
$string['headerlisttemplate'] = 'Mendefinisikan antarmuka penjelajahan untuk banyak entri';
$string['headerrsstemplate'] = 'Mendefinisikan tampilan entri di umpan RSS';
$string['headersingletemplate'] = 'Mendefinisikan antarmuka penjelajahan untuk satu entri';
$string['importentries'] = 'Impor entri';
$string['importsuccess'] = 'Preset telah berhasil diterapkan.';
...
$string['indicator:cognitivedepthdef_help'] = 'Peserta telah mencapai persentase keterlibatan kognitif yang ditawarkan oleh aktivitas basis data selama interval analisis ini (Tingkat = Tidak ada tampilan, Lihat, Kirim)';
...
$string['jstemplate'] = 'Templat Javascript';
...
$string['listtemplate'] = 'Daftar templat';
$string['longitude'] = 'Garis bujur';
$string['manageapproved'] = 'Izinkan pengeditan entri yang disetujui';
$string['manageapproved_help'] = 'Jika dinonaktifkan, entri yang disetujui tidak lagi dapat diedit atau dihapus oleh pengguna yang menambahkannya. Setelan ini tidak berpengaruh kecuali \'Persetujuan diperlukan\' diaktifkan.';
...
$string['modulename_help'] = 'Modul aktivitas basis data memungkinkan peserta untuk membuat, memelihara, dan mencari kumpulan entri (yaitu catatan). Struktur entri didefinisikan oleh guru sebagai sejumlah bidang. Jenis bidang termasuk kotak centang, tombol radio, menu tarik-turun, area teks, URL, gambar, dan file yang diunggah.

Tata letak visual informasi saat membuat daftar, melihat, atau mengedit entri basis data dapat dikontrol oleh templat basis data. Kegiatan database dapat dibagi antara kursus sebagai preset dan guru juga dapat mengimpor dan mengekspor entri database.

Jika filter penautan otomatis basis data diaktifkan, setiap entri dalam basis data akan secara otomatis ditautkan ke tempat kata atau frasa muncul dalam kursus.

Seorang pengajar dapat mengizinkan komentar pada entri. Entri juga dapat dinilai oleh pengajar atau siswa (evaluasi rekan sejawat). Peringkat dapat dikumpulkan untuk membentuk nilai akhir yang dicatat dalam buku nilai.

Aktivitas basis data memiliki banyak kegunaan, seperti:

* Koleksi kolaboratif tautan web, buku, ulasan buku, referensi jurnal, dll.
* Untuk menampilkan foto, poster, situs web, atau puisi buatan siswa untuk komentar dan ulasan sejawat.';
...
$string['norecords'] = 'Tidak ada entri dalam database';
$string['nosingletemplate'] = 'Templat tunggal belum ditentukan';
$string['notapproved'] = 'Entri belum disetujui.';
...
$string['overrwritedesc'] = 'Timpa preset jika sudah ada';
$string['overwrite'] = 'Timpa';
$string['overwritesettings'] = 'Timpa setelan saat ini';
...
$string['privacy:metadata:commentpurpose'] = 'Komentar pada rekaman database';
$string['privacy:metadata:data_content'] = 'Merupakan satu jawaban untuk satu ruas dalam modul aktivitas basis data';
...
$string['privacy:metadata:data_records'] = 'Mewakili rekaman dalam modul aktivitas basis data';
...
$string['privacy:metadata:tagpurpose'] = 'Label pada rekaman database';
...
$string['requireapproval_help'] = 'Jika diaktifkan, entri memerlukan persetujuan guru sebelum dapat dilihat oleh semua orang.';
...
$string['requiredentriestoview_help'] = 'Jumlah entri yang harus diserahkan oleh siswa sebelum mereka dapat melihat entri dari siswa lain. Catatan: Jika entri diperlukan sebelum melihat, filter penautan otomatis basis data harus dinonaktifkan. Ini karena filter penautan otomatis basis data tidak dapat menentukan apakah pengguna telah mengirimkan jumlah entri yang diperlukan.';
...
$string['resetsettings'] = 'Setel ulang filter';
...
$string['saveaspreset'] = 'Simpan sebagai preset';
...
$string['savesuccess'] = 'Berhasil disimpan. Preset Anda sekarang akan tersedia di seluruh situs.';
...
$string['single'] = 'Tampilkan satu';
$string['singletemplate'] = 'Templat tunggal';
...
$string['tagarea_data_records'] = 'Catatan data';
$string['tags'] = 'Tag';
...
$string['unsupportedexport'] = '({$a->fieldtype}) tidak dapat diekspor.';
...
$string['uploadrecords'] = 'Unggah entri dari berkas';
$string['uploadrecords_help'] = 'Entri dapat diunggah melalui berkas teks. Format berkas harus sebagai berikut: * Setiap baris berkas berisi satu rekaman * Setiap rekaman adalah serangkaian data yang dipisahkan dengan koma (atau pembatas lainnya) * Rekaman pertama berisi daftar nama ruas yang mendefinisikan format sisanya dari berkas penutup ruas adalah karakter yang mengelilingi setiap ruas di setiap rekaman. Biasanya dapat dibiarkan tidak disetel.';
$string['url'] = 'URL';
$string['usedate'] = 'Termasuk dalam pencarian.';
