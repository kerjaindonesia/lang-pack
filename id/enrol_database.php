...
/**
 * Strings for component 'enrol_database', language 'id', version '3.9'.
 *
...
$string['database:config'] = 'Host basis data';
$string['database:unenrol'] = 'Keluarkan pengguna yang ditangguhkan';
$string['dbencoding'] = 'Pengkodean database';
$string['dbhost'] = 'Host basis data';
$string['dbhost_desc'] = 'Ketik alamat IP server database atau nama host. Gunakan nama DSN sistem jika menggunakan ODBC. Gunakan PDO DSN jika menggunakan PDO.';
...
$string['debugdb_desc'] = 'Debug koneksi ADOdb ke database eksternal - gunakan saat mendapatkan halaman kosong selama login. Tidak cocok untuk tempat produksi!';
