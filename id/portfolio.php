...
/**
 * Strings for component 'portfolio', language 'id', version '3.9'.
 *
 * @package     portfolio
 * @category    string
...
$string['insanebody'] = 'Hai! Anda menerima pesan ini sebagai administrator {$a->sitename}.

Beberapa model pengaya portofolio telah dinonaktifkan secara otomatis karena kesalahan konfigurasi. Artinya, pengguna saat ini tidak dapat mengekspor konten ke portofolio ini.

Daftar model pengaya portofolio yang telah dinonaktifkan adalah:

{$a->textlist}

Ini harus diperbaiki secepat mungkin, dengan mengunjungi {$a->fixurl}.';
$string['insanebodyhtml'] = '<p> Hai! Anda menerima pesan ini sebagai administrator {$a->sitename}. </p>
<p> Beberapa model pengaya portofolio telah dinonaktifkan secara otomatis karena kesalahan konfigurasi. Artinya, pengguna saat ini tidak dapat mengekspor konten ke portofolio ini. </p>
<p> Daftar model pengaya portofolio yang telah dinonaktifkan adalah: </p>
{$a->htmllist}
<p> Ini harus diperbaiki secepat mungkin, dengan mengunjungi <a href="{$a->fixurl} "> halaman konfigurasi portofolio </a> </p>';
...
$string['privacy:metadata:instancesummary'] = 'Menyimpan data tentang model portofolio dan preferensi.';
