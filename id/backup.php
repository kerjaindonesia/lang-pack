...
/**
 * Strings for component 'backup', language 'id', version '3.9'.
 *
 * @package     backup
 * @category    string
...
$string['config_overwrite_course_shortname'] = 'Secara bawaan, timpa nama pendek kursus dengan nama yang ada di berkas cadangan. Ini membutuhkan "Timpa konfigurasi kursus" untuk diperiksa dan pengguna saat ini memiliki kemampuan untuk mengubah nama pendek kursus (moodle/course:changeshortname)';
...
$string['errorrestorefrontpagebackup'] = 'Anda hanya dapat memulihkan cadangan halaman depan di halaman depan';
...
$string['sitecourseformatwarning'] = 'Ini adalah cadangan halaman depan, perhatikan bahwa mereka hanya dapat dipulihkan di halaman depan';
