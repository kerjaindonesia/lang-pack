...
/**
 * Strings for component 'enrol_paypal', language 'id', version '3.9'.
 *
...
$string['paypal:config'] = 'Konfigurasikan contoh pendaftaran PayPal';
...
$string['privacy:metadata:enrol_paypal:enrol_paypal:instanceid'] = 'ID contoh pendaftaran dalam kursus.';
