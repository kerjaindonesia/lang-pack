...
/**
 * Strings for component 'quiz_statistics', language 'id', version '3.9'.
 *
...
$string['negcovar_help'] = 'Nilai pertanyaan ini untuk rangkaian percobaan pada kuis ini berbeda-beda dengan cara yang berlawanan dengan nilai percobaan keseluruhan. Ini berarti nilai percobaan keseluruhan cenderung di bawah rata-rata jika nilai untuk pertanyaan ini di atas rata-rata dan sebaliknya.

Perhitungan kami untuk bobot pertanyaan efektif tidak dapat dihitung dalam kasus ini. Perhitungan bobot pertanyaan efektif untuk pertanyaan lain dalam kuis ini merupakan bobot pertanyaan efektif untuk pertanyaan tersebut jika pertanyaan yang disorot dengan kovarian negatif diberi nilai maksimal nol.

Jika Anda mengedit sebuah kuis dan memberikan pertanyaan-pertanyaan ini dengan kovarian negatif nilai maksimal nol maka bobot pertanyaan efektif dari pertanyaan-pertanyaan ini akan menjadi nol dan bobot pertanyaan efektif nyata dari pertanyaan lain akan dihitung sekarang.';
...
$string['quizstatisticscleanuptask'] = 'Bersihkan kuis statistik tembolok rekaman lama';
