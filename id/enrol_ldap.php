...
/**
 * Strings for component 'enrol_ldap', language 'id', version '3.9'.
 *
 * @package     enrol_ldap
 * @category    string
...
$string['autocreate'] = '<p> Kursus dapat dibuat secara otomatis jika ada pendaftaran ke kursus yang belum ada di Moodle </p> <p> Jika Anda menggunakan pembuatan kursus otomatis, disarankan agar Anda menghapus kemampuan berikut: moodle/course:changeidnumber, moodle/course:changeshortname, moodle/course:changefullname dan moodle/course:changesummary, dari peran yang relevan untuk mencegah modifikasi dari empat bidang kursus yang ditentukan di atas (nomor ID, nama pendek, nama lengkap dan ringkasan). </p>';
...
$string['cannotupdatecourse'] = 'Tidak dapat memperbarui pelajran: data yang diperlukan tidak ada dari data LDAP!  Nomor ID kursus: \'{$a->idnumber}\'';
...
$string['idnumber_attribute'] = 'Jika keanggotaan grup berisi nama yang berbeda, tentukan atribut yang sama yang telah Anda gunakan untuk pemetaan \'Nomor ID\' pengguna di setelan otentikasi LDAP.';
...
$string['user_attribute'] = 'Jika keanggotaan grup berisi nama-nama yang berbeda, tentukan atribut yang digunakan untuk memberi nama / mencari pengguna. Jika Anda menggunakan otentikasi LDAP, nilai ini harus cocok dengan atribut yang ditentukan dalam pemetaan \'Nomor ID\' di pengaya autentikasi LDAP.';
...
$string['version'] = 'Versi protokol LDAP yang digunakan server Anda';
