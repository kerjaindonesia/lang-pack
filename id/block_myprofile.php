...
/**
 * Strings for component 'block_myprofile', language 'id', version '3.9'.
 *
...
$string['display_phone1'] = 'Tampilkan telepon';
$string['display_phone2'] = 'Tampilkan ponsel';
$string['display_picture'] = 'Tampilkan gambar';
$string['display_skype'] = 'Tampilkan Skype';
$string['display_yahoo'] = 'Tampilkan Yahoo';
$string['myprofile:addinstance'] = 'Tambahkan login baru di blok pengguna';
$string['myprofile:myaddinstance'] = 'Tambahkan blok pengguna yang baru login di Beranda saya';
$string['myprofile_settings'] = 'Informasi pengguna visible';
$string['pluginname'] = 'Pengguna yang sudah login';
$string['privacy:metadata'] = 'Blok pengguna yang masuk hanya menampilkan informasi pengguna yang masuk dan tidak menyimpan data itu sendiri.';
