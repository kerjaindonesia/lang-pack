...
/**
 * Strings for component 'scorm', language 'id', version '3.9'.
 *
 * @package     scorm
 * @category    string
...
$string['aicchacpkeepsessiondata_desc'] = 'Lamanya waktu dalam hari untuk menyimpan data sesi AICC HACP eksternal (setelan tinggi akan mengisi tabel dengan data lama tetapi mungkin berguna saat debugging)';
...
$string['autocommit_help'] = 'Jika diaktifkan, data SCORM secara otomatis disimpan ke basis data. Berguna untuk objek SCORM yang tidak menyimpan datanya secara teratur.';
...
$string['completionscorerequired_help'] = 'Mengaktifkan setelan ini akan mengharuskan pengguna untuk memiliki setidaknya skor minimum yang dimasukkan untuk ditandai selesai dalam aktivitas SCORM ini, serta persyaratan Penyelesaian Aktivitas lainnya.';
...
$string['completionstatusallscos'] = 'Membutuhkan semua scos untuk mengembalikan status penyelesaian';
...
$string['completionstatusrequired_help'] = 'Memeriksa satu atau lebih status akan mengharuskan pengguna untuk mencapai setidaknya satu dari status yang diperiksa agar ditandai selesai dalam aktivitas SCORM ini, serta persyaratan Penyelesaian Aktivitas lainnya.';
...
$string['deleteallattempts'] = 'Hapus semua upaya SCORM';
...
$string['displayactivityname'] = 'Tampilkan nama aktivitas';
$string['displayactivityname_help'] = 'Apakah akan menampilkan nama aktivitas di atas pemutar SCORM atau tidak.';
...
$string['displaycoursestructure'] = 'Tampilkan struktur kursus di halaman entri';
...
$string['forcenewattempts_help'] = 'Ada 3 pilihan: * Tidak - Jika percobaan sebelumnya selesai, lulus atau gagal, siswa akan diberikan pilihan untuk masuk ke mode peninjauan atau memulai percobaan baru. * Ketika percobaan sebelumnya selesai, lulus atau gagal - Ini bergantung pada paket SCORM yang mengatur status \'selesai\', \'lulus\' atau \'gagal\'. * Selalu - Setiap entri ulang ke aktivitas SCORM akan menghasilkan upaya baru dan siswa tidak akan dikembalikan ke titik yang sama yang mereka capai dalam upaya sebelumnya.';
...
$string['grademethod_help'] = 'Metode penilaian menentukan bagaimana nilai untuk satu upaya aktivitas ditentukan. Ada 4 metode penilaian: * Objek pembelajaran - Jumlah objek pembelajaran yang diselesaikan/lulus * Nilai tertinggi - Nilai tertinggi yang diperoleh pada semua objek pembelajaran yang lulus * Nilai rata-rata - Rata-rata semua nilai * Jumlah nilai - Jumlah semua skor';
...
$string['hidetoc'] = 'Tampilkan struktur kursus di pemutar';
...
$string['masteryoverridedesc'] = 'Preferensi ini menetapkan bawaan untuk pengaturan penggantian skor penguasaan';
...
$string['noattemptsallowed'] = 'Jumlah upaya yang diperbolehkan';
...
$string['optionsadv_desc'] = 'Jika dicentang lebar dan tinggi akan terdaftar sebagai pengaturan lanjutan.';
...
$string['popuplaunched'] = 'Paket SCORM ini telah diluncurkan di jendela popup, Jika Anda telah selesai melihat sumber ini, klik di sini untuk kembali ke halaman kursus';
...
$string['privacy:metadata:scorm_scoes_track'] = 'Data terlacak dari SCO yang termasuk dalam aktivitas';
...
$string['reviewmode'] = 'Mode peninjauan';
...
$string['scormstandarddesc'] = 'Saat dinonaktifkan, Moodle mengizinkan paket SCORM 1.2 untuk menyimpan lebih dari yang diizinkan spesifikasi, dan menggunakan pengaturan format nama lengkap Moodle saat meneruskan nama pengguna ke paket SCORM.';
$string['scormtype'] = 'Jenis';
$string['scormtype_help'] = 'Setelan ini menentukan bagaimana paket disertakan dalam kursus. Ada hingga 4 opsi: * Paket yang diunggah - Memungkinkan paket SCORM untuk dipilih melalui pemilih berkas * Manifes SCORM eksternal - Memungkinkan URL imsmanifest.xml untuk ditentukan. Catatan: Jika URL memiliki nama domain yang berbeda dari situs Anda, maka "Paket yang diunduh" adalah pilihan yang lebih baik, karena jika tidak, nilai tidak akan disimpan. * Paket yang diunduh - Memungkinkan URL paket ditentukan. Paket akan dibuka ritsletingnya dan disimpan secara lokal, dan diperbarui ketika paket SCORM eksternal diperbarui. * URL AICC Eksternal - URL ini adalah URL peluncuran untuk Aktivitas AICC tunggal. Paket psuedo akan dibangun di sekitar ini.';
...
$string['unziperror'] = 'Terjadi kesalahan saat membuka paket zip';
...
$string['whatgrade_help'] = 'Jika beberapa upaya diperbolehkan,setelan ini menentukan apakah upaya tertinggi, rata-rata (mean), pertama atau terakhir yang diselesaikan dicatat dalam buku nilai. Opsi upaya terakhir yang diselesaikan tidak termasuk upaya dengan status \'gagal\'. Catatan tentang penanganan beberapa upaya: * Opsi untuk memulai upaya baru disediakan oleh kotak centang di atas tombol Enter pada halaman struktur konten, jadi pastikan Anda memberikan akses ke halaman itu jika Anda ingin mengizinkan lebih dari satu upaya . * Beberapa paket SCORM cerdas tentang upaya baru, banyak yang tidak. Artinya, jika pelajar memasukkan kembali upaya yang ada, jika konten SCORM tidak memiliki logika internal untuk menghindari menimpa upaya sebelumnya, mereka dapat ditimpa, meskipun upaya itu \'selesai\' atau \'lulus\'. * Pengaturan "Paksa selesai", "Paksa upaya baru" dan "Kunci setelah upaya terakhir" juga menyediakan pengelolaan lebih lanjut dari beberapa upaya.';
