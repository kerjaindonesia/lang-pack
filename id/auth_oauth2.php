...
/**
 * Strings for component 'auth_oauth2', language 'id', version '3.9'.
 *
 * @package     auth_oauth2
 * @category    string
...
$string['confirmaccountemail'] = 'Hai {$a->fullname},
...
$string['confirmlinkedloginemail'] = 'Hai {$a->fullname},

Permintaan telah dibuat untuk menautkan log masuk {$a->issuername} {$a->linkedemail} ke akun Anda di \'{$a->sitename}\'
menggunakan alamat surel Anda.
