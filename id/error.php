...
/**
 * Strings for component 'error', language 'id', version '3.9'.
 *
 * @package     error
 * @category    string
...
$string['internalauthpassworderror'] = 'Kata sandi tidak ada atau kebijakan kata sandi tidak valid untuk otentikasi internal';
...
$string['noparticipants'] = 'Tidak ada peserta yang ditemukan untuk kursus ini';
...
$string['serverconnection'] = 'Kesalahan saat menyambung ke server';
...
$string['upgraderequires19'] = 'Kesalahan: Versi Moodle baru dipasang di peladen, sayangnya peningkatan versi dari versi sebelumnya tidak didukung. <br /> Harap tingkatkan dulu ke rilis 1.9.x terbaru. Anda juga dapat kembali ke versi sebelumnya dengan memasang ulang berkas asli.';
...
$string['usernotaddederror'] = 'Pengguna tidak ditambahkan - kesalahan';
...
$string['usernotfullysetup'] = 'Seting pengguna tidak sepenuhnya selesai';
