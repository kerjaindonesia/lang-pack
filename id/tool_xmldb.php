...
/**
 * Strings for component 'tool_xmldb', language 'id', version '3.9'.
 *
 * @package     tool_xmldb
 * @category    string
...
$string['duplicatefieldname'] = 'Ruas lain dengan nama tersebut sudah ada';
...
$string['fieldsusedinkey'] = 'Ruas ini digunakan sebagai kunci.';
...
$string['floatincorrectlength'] = 'Panjang salah untuk ruas float';
...
$string['incorrectfieldname'] = 'Nama salah';
...
$string['integerincorrectlength'] = 'Panjang salah untuk ruas integer';
$string['key'] = 'Kunci';
...
$string['nowrongdefaultsfound'] = 'Tidak ada nilai default yang tidak konsisten yang ditemukan, DB Anda tidak memerlukan tindakan lebih lanjut.';
$string['nowrongintsfound'] = 'Tidak ada integer yang salah yang ditemukan, DB Anda tidak memerlukan tindakan lebih lanjut.';
...
$string['numberincorrectdecimals'] = 'Jumlah desimal yang salah untuk ruas numerik';
$string['numberincorrectlength'] = 'Panjang salah untuk ruas numerik';
$string['numberincorrectwholepart'] = 'Bagian bilangan bulat terlalu besar untuk ruas bilangan';
...
$string['primarykeyonlyallownotnullfields'] = 'Kunci primer tidak boleh nol';
$string['privacy:metadata'] = 'Pengaya editor XMLDB tidak menyimpan data pribadi apa pun.';
$string['reserved'] = 'Cadangan';
$string['reservedwords'] = 'Kata-kata yang dicadangkan';
$string['revert'] = 'Kembali semula';
...
$string['yeswrongdefaultsfound'] = '<p>Beberapa bawaan yang tidak konsisten telah ditemukan di DB Anda. Berikut adalah detailnya dan pernyataan SQL yang diperlukan untuk dieksekusi dengan antarmuka SQL favorit Anda untuk memperbaiki semuanya. Ingatlah untuk membuat cadangan data Anda terlebih dahulu!</p>
<p>Setelah melakukannya, sangat disarankan untuk menjalankan utilitas ini lagi untuk memeriksa bahwa tidak ada lagi bawaan yang tidak konsisten yang ditemukan.</p>';
$string['yeswrongintsfound'] = '<p>Beberapa bilangan bulat yang salah telah ditemukan di DB Anda. Berikut adalah detailnya dan pernyataan SQL yang diperlukan untuk dieksekusi dengan antarmuka SQL favorit Anda untuk memperbaikinya. Ingatlah untuk membuat cadangan data Anda terlebih dahulu!</p>
<p>Setelah memperbaikinya, sangat disarankan untuk menjalankan utilitas ini lagi untuk memeriksa bahwa tidak ada lagi bilangan bulat yang salah ditemukan.</p>';
