...
/**
 * Strings for component 'tool_uploaduser', language 'id', version '3.9'.
 *
...
$string['examplecsv_help'] = 'Untuk menggunakan  berkas teks contoh, unduh lalu buka dengan editor teks atau spreadsheet. Biarkan baris pertama tidak berubah, lalu edit baris (rekaman) berikut dan tambahkan data pengguna Anda, tambahkan lebih banyak baris seperlunya. Simpan berkas sebagai CSV lalu unggah.

Berkas teks contoh juga dapat digunakan untuk pengujian, karena Anda dapat melihat pratinjau data pengguna dan dapat memilih untuk membatalkan tindakan sebelum akun pengguna dibuat.';
...
$string['uploaduserspreview'] = 'Unggah pratinjau pengguna';
$string['uploadusersresult'] = 'Unggah hasil pengguna';
...
$string['userthemesnotallowed'] = 'Tema pengguna tidak diaktifkan, jadi semua yang disertakan dalam berkas pengguna yang diunggah akan diabaikan.';
