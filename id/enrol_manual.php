...
/**
 * Strings for component 'enrol_manual', language 'id', version '3.9'.
 *
...
$string['confirmbulkdeleteenrolment'] = 'Anda yakin ingin menghapus pendaftaran para pengguna ini?';
...
a->users} Untuk memperpanjang pendaftaran mereka, buka {$a->extendurl}';
...
$string['wsnoinstance'] = 'Instance plugin pendaftaran manual tidak ada atau dinonaktifkan untuk kursus (id = {$a->courseid})';
