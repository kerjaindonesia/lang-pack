...
/**
 * Strings for component 'admin', language 'id', version '3.9'.
 *
 * @package     admin
 * @category    string
...
$string['allowguestmymoodle'] = 'Memungkinkan akses tamu ke Beranda';
...
$string['configallowguestmymoodle'] = 'Jika diaktifkan, tamu dapat mengakses Dasbor, jika tidak, tamu dialihkan ke laman muka situs.';
