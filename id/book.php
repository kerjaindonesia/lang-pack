...
/**
 * Strings for component 'book', language 'id', version '3.9'.
 *
 * @package     book
 * @category    string
...
$string['content'] = 'Isi';
$string['customtitles'] = 'Judul tersuai';
$string['customtitles_help'] = 'Biasanya judul bab ditampilkan dalam daftar isi (TOC) DAN sebagai judul di atas konten.

Jika kotak centang judul tersuai dicentang, judul bab TIDAK ditampilkan sebagai judul di atas konten. Judul yang berbeda (mungkin lebih panjang dari judul bab) dapat dimasukkan sebagai bagian dari konten.';
$string['deletechapter'] = 'Hapus bab "{$a}"';
$string['editchapter'] = 'Edit bab "{$a}"';
$string['editingchapter'] = 'Mengedit bab';
$string['errorchapter'] = 'Kesalahan membaca bab buku.';
...
$string['indicator:cognitivedepthdef_help'] = 'Peserta telah mencapai persentase keterlibatan kognitif yang ditawarkan oleh aktivitas buku selama interval analisis ini (Levels = No view, View)';
...
$string['modulename_help'] = 'Modul buku memungkinkan seorang pengajar untuk membuat sumber daya multi-halaman dalam format seperti buku, dengan bab dan subbab. Buku dapat berisi berkas media serta teks dan berguna untuk menampilkan bagian informasi yang panjang yang dapat dipecah menjadi beberapa bagian. Sebuah buku dapat digunakan * Untuk menampilkan bahan bacaan untuk modul studi individu * Sebagai buku pegangan departemen staf * Sebagai portofolio karya siswa';
...
$string['navstyle_help'] = '* Gambar - Ikon digunakan untuk navigasi * Teks - Judul bab digunakan untuk navigasi';
$string['navtext'] = 'Teks';
$string['navtoc'] = 'Hanya Daftar Isi';
...
$string['numbering_help'] = '* Tidak ada - Judul bab dan subbab tidak memiliki format
* Angka - Judul bab dan subbab diberi nomor 1, 1.1, 1.2, 2, ...
* Peluru - Subbab diindentasi dan ditampilkan dengan peluru di daftar isi
* Indentasi - Sub-bab diindentasi dalam daftar isi';
...
$string['removeallbooktags'] = 'Hapus semua label buku';
