...
/**
 * Strings for component 'search', language 'id', version '3.9'.
 *
 * @package     search
 * @category    string
...
$string['confirm_indexall'] = 'Yakin ingin memperbarui konten yang diindeks sekarang? Jika sejumlah besar konten perlu diindeks, ini bisa memakan waktu lama. Untuk server langsung, Anda biasanya harus membiarkan pengindeksan ke tugas terjadwal \'Pengindeksan pencarian global\'.';
...
$string['core-all'] = 'Semua';
$string['core-course-content'] = 'Konten kursus';
$string['core-other'] = 'Lainnya';
$string['core-users'] = 'Pengguna';
...
$string['emptydatabaseerror'] = 'Tabel basis data tidak ada, atau tidak berisi catatan indeks.';
...
$string['mycoursesonly'] = 'Hanya kursus saya';
...
$string['search:course'] = 'Kursus';
$string['search:customfield'] = 'Ruas kustom kursus';
...
$string['searchareacategories'] = 'Cari kategori area';
