...
/**
 * Strings for component 'qtype_calculated', language 'id', version '3.9'.
 *
...
$string['atleastonerealdataset'] = 'Harus ada setidaknya satu dataset nyata dalam teks pertanyaan';
...
$string['choosedatasetproperties_help'] = 'Kumpulan data adalah sekumpulan nilai yang disisipkan sebagai pengganti kartu liar. Anda dapat membuat kumpulan data pribadi untuk soal tertentu, atau kumpulan data bersama yang dapat digunakan untuk pertanyaan terhitung lainnya dalam kategori.';
...
$string['existingcategory2'] = 'berkas dari kumpulan berkas yang sudah ada yang juga digunakan oleh pertanyaan lain dalam kategori ini';
$string['existingcategory3'] = 'tautan dari kumpulan tautan yang sudah ada yang juga digunakan oleh pertanyaan lain dalam kategori ini';
$string['forceregeneration'] = 'paksa regenerasi';
$string['forceregenerationall'] = 'regenerasi paksa semua kartu liar';
$string['forceregenerationshared'] = 'regenerasi paksa hanya kartu liar yang tidak dibagikan';
...
$string['keptlocal2'] = 'berkas dari kumpulan berkas pribadi pertanyaan yang sama seperti sebelumnya';
$string['keptlocal3'] = 'tautan dari kumpulan tautan pribadi pertanyaan yang sama seperti sebelumnya';
...
$string['missingname'] = 'Nama pertanyaan tidak ada';
$string['missingquestiontext'] = 'Teks pertanyaan hilang';
...
$string['privacy:metadata'] = 'Pengaya jenis pertanyaan terhitung tidak menyimpan data pribadi apa pun.';
