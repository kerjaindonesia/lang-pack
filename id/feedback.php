...
/**
 * Strings for component 'feedback', language 'id', version '3.9'.
 *
 * @package     feedback
 * @category    string
...
$string['complete_the_form'] = 'Jawab pertanyaan berikut';
$string['completed'] = 'Lengkap';
$string['completed_feedbacks'] = 'Jawaban yang diserahkan';
$string['completedon'] = 'Selesai pada {$a}';
$string['completionsubmit'] = 'Lihat sebagai selesai jika umpan balik dikirimkan';
$string['configallowfullanonymous'] = 'Jika disetel ke \'ya\', pengguna dapat menyelesaikan aktivitas umpan balik di halaman depan tanpa harus masuk.';
...
$string['delete_old_items'] = 'Hapus item lama';
...
$string['feedback:deletesubmissions'] = 'Hapus pengajuan yang telah selesai';
...
$string['feedbackclose'] = 'Bolehkan jawab kepada';
...
$string['handling_error'] = 'Terjadi kesalahan dalam penanganan tindakan modul umpan balik';
...
$string['indicator:socialbreadthdef_help'] = 'Peserta telah mencapai persentase keterlibatan sosial yang ditawarkan oleh aktivitas umpan balik selama interval analisis ini (Tingkat = Tidak ada partisipasi, Peserta sendiri, Peserta dengan orang lain)';
...
$string['modulename_help'] = 'Modul aktivitas umpan balik memungkinkan guru membuat survei khusus untuk mengumpulkan umpan balik dari peserta menggunakan berbagai jenis pertanyaan termasuk pilihan ganda, ya/tidak, atau input teks.

Tanggapan umpan balik mungkin anonim jika diinginkan, dan hasilnya dapat ditampilkan kepada semua peserta atau dibatasi hanya untuk guru. Setiap aktivitas umpan balik di halaman depan situs juga dapat diselesaikan oleh pengguna yang tidak masuk.

Aktivitas umpan balik dapat digunakan

* Untuk evaluasi kursus, membantu meningkatkan konten untuk peserta nanti
...
* Untuk survei anti-intimidasi di mana siswa dapat melaporkan insiden secara anonim';
...
$string['multiplesubmit_help'] = 'Jika diaktifkan untuk survei anonim, pengguna dapat mengirimkan umpan balik dalam jumlah yang tidak terbatas.';
$string['name'] = 'Nama';
$string['name_required'] = 'Nama dibutuhkan';
$string['nameandlabelformat'] = '({$a->label}) {$a->name}';
$string['next_page'] = 'Halaman berikutnya';
...
$string['resetting_data'] = 'Setel ulang tanggapan umpan balik';
$string['resetting_feedbacks'] = 'Mereset umpan balik';
$string['response_nr'] = 'Jumlah respon';
$string['responses'] = 'Respon';
$string['responsetime'] = 'Waktu tanggapan';
$string['save_as_new_item'] = 'Simpan sebagai pertanyaan baru';
$string['save_as_new_template'] = 'Simpan sebagai templat baru';
$string['save_entries'] = 'Kirim jawaban anda';
...
$string['show_entries'] = 'Tunjukkan respon';
$string['show_entry'] = 'Tampilkan tanggapan';
$string['show_nonrespondents'] = 'Tunjukkan non-responden';
...
$string['this_feedback_is_already_submitted'] = 'Anda telah menyelesaikan aktivitas ini.';
...
$string['use_this_template'] = 'Gunakan templat ini';
