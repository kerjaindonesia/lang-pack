...
/**
 * Strings for component 'choice', language 'id', version '3.9'.
 *
 * @package     choice
 * @category    string
...
$string['cannotsubmit'] = 'Maaf, ada masalah saat mengirim pilihan Anda. Silakan coba lagi.';
...
$string['choiceactivityname'] = 'Pemilihan: {$a}';
$string['choiceclose'] = 'Izinkan menanggapi sampai';
$string['choicecloseson'] = 'Pemilihan ditutup pada {$a}';
...
$string['choiceoptions'] = 'Opsi-opsi pilihan';
$string['choiceoptions_help'] = 'Di sini adalah tempat dimanan Anda menentukan pilihan yang harus dipilih oleh peserta.

Anda dapat mengisi nomor-nomor ini. Jika Anda membiarkan beberapa opsi kosong, mereka tidak akan ditampilkan. Jika Anda membutuhkan lebih dari 8 opsi, klik tombol "Tambahkan 3 kolom pada formulir".';
...
$string['completionsubmit'] = 'Tampilkan sebagai lengkap saat pengguna membuat pilihan';
$string['description'] = 'Teks Pendahuluan';
...
$string['indicator:cognitivedepthdef_help'] = 'Peserta telah mencapai persentase keterlibatan kognitif yang ditawarkan oleh aktivitas Pilihan selama interval analisis ini (Tingkat = Tidak ada tampilan, Lihat, Kirim, Lihat umpan balik)';
...
$string['indicator:socialbreadthdef_help'] = 'Peserta telah mencapai persentase keterlibatan sosial yang ditawarkan oleh aktivitas Pilihan selama interval analisis ini (Tingkat = Tidak ada partisipasi, Peserta sendiri, Peserta dengan orang lain)';
$string['limit'] = 'Batas';
$string['limitanswers'] = 'Batasi jumlah jawaban yang diperbolehkan';
$string['limitanswers_help'] = 'Opsi ini memungkinkan Anda untuk membatasi jumlah peserta yang dapat memilih setiap opsi pilihan. Ketika batas tercapai maka tidak ada orang lain yang dapat memilih opsi itu. Harap dicatat bahwa jika Anda menggunakan aktivitas ini dalam mode grup, maka batasnya adalah per grup. Misalnya, jika batas ditetapkan ke 5, maka 5 anggota dari setiap grup dapat memilih opsi tersebut. Jika ada 3 kelompok, ini berarti maksimal 5 x 3 = 15 peserta dapat memilih opsi tersebut. Jika batas dinonaktifkan maka sejumlah peserta dapat memilih masing-masing opsi.';
$string['limitno'] = 'Batas {no}';
$string['modulename'] = 'Pemilihan';
$string['modulename_help'] = 'Modul aktivitas Pemilihan memungkinkan seorang guru untuk mengajukan satu pertanyaan dan menawarkan pilihan jawaban yang mungkin. Hasil pemilihan dapat dipublikasikan setelah siswa menjawab, setelah tanggal tertentu, atau tidak sama sekali. Hasil dapat dipublikasikan dengan nama siswa atau tanpa nama (meskipun guru selalu melihat nama siswa dan jawaban mereka). Aktivitas Pemilihan dapat digunakan * Sebagai jajak pendapat cepat untuk merangsang pemikiran tentang suatu topik * Untuk dengan cepat menguji pemahaman siswa * Untuk memfasilitasi pengambilan keputusan siswa, misalnya memungkinkan siswa untuk memberikan suara pada arah mata kursus';
$string['modulenameplural'] = 'Pilihan-pilihan';
...
$string['numberofuser'] = 'Jumlah respon';
$string['numberofuserinpercentage'] = 'Persentasi respon';
...
$string['pluginname'] = 'Pilihan';
$string['previewonly'] = 'Ini hanya pratinjau opsi yang tersedia untuk kegiatan ini. Anda tidak akan dapat mengirim pilihan Anda hingga {$ a}.';
...
$string['publishinfonever'] = 'Hasil kegiatan ini tidak akan dipublikasikan setelah Anda menjawab.';
...
$string['removeresponses'] = 'Hapus semua tanggapan';
...
$string['showpreview_help'] = 'Izinkan siswa untuk melihat pratinjau opsi yang tersedia sebelum pilihan dibuka untuk diajukan.';
