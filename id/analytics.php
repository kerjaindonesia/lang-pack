...
/**
 * Strings for component 'analytics', language 'id', version '3.9'.
 *
 * @package     analytics
 * @category    string
...
$string['errorcannotreaddataset'] = 'File set data {$a} tidak dapat dibaca.';
$string['errorcannotusetimesplitting'] = 'Interval analisis yang diberikan tidak dapat digunakan pada model ini.';
$string['errorcannotwritedataset'] = 'File set data {$ a} tidak dapat ditulis.';
$string['errorexportmodelresult'] = 'Model pembelajaran mesin tidak dapat diekspor.';
$string['errorimport'] = 'Terjadi kesalahan saat mengimpor file JSON yang disediakan.';
...
$string['incorrectlyflagged'] = 'Ditandai dengan salah';
...
$string['levelinstitutionisced1'] = 'Pendidikan Utama';
$string['levelinstitutionisced2'] = 'Pendidikan menengah pertama';
$string['levelinstitutionisced3'] = 'Pendidikan menengah atas';
...
$string['levelinstitutionisced6'] = 'Sarjana atau setara';
$string['levelinstitutionisced7'] = 'Master atau level setara';
$string['levelinstitutionisced8'] = 'Tingkat doktor atau setara';
...
$string['modeinstructionfullyonline'] = 'Sepenuhnya online';
$string['modeloutputdir'] = 'Model direktori output';
$string['modeloutputdirinfo'] = 'Direktori tempat pemroses prediksi menyimpan semua info evaluasi. Berguna untuk debugging dan penelitian.';
$string['modeltimelimit'] = 'Batas waktu analisis per model';
$string['modeltimelimitinfo'] = 'Pengaturan ini membatasi waktu yang dihabiskan setiap model untuk menganalisis konten situs.';
...
$string['novaliddata'] = 'Tidak ada data valid yang tersedia';
...
$string['privacy:metadata:analytics:indicatorcalc:endtime'] = 'Kalkulasi';
