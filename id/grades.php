...
/**
 * Strings for component 'grades', language 'id', version '3.9'.
 *
 * @package     grades
 * @category    string
...
$string['removeallcoursegrades_help'] = 'Apabila dipilih, seluruh item nilai yang ditambahkan secara manual ke buku nilai akan dihapus bersama dengan nilai dan data yang tertimpa, yang tidak dimasukkan (dikecualikan), disembunyikan, dan nilai yang terkunci. Hanya item nilai yang berhubungan dengan aktivitas yang tidak akan terhapus.';
