...
/**
 * Strings for component 'tool_dbtransfer', language 'id', version '3.9'.
 *
...
$string['targetdatabasenotempty'] = 'Basis data target tidak boleh berisi tabel apa pun dengan prefiks yang diberikan!';
