...
/**
 * Strings for component 'repository_picasa', language 'id', version '3.9'.
 *
...
$string['configplugin'] = 'Konfigurasi repositori Picasa';
...
$string['picasa:view'] = 'Lihat repositori picasa';
$string['pluginname'] = 'Picasa web album';
$string['privacy:metadata:repository_picasa'] = 'Plugin penyimpanan album web Picasa tidak menyimpan data pribadi apa pun, tetapi mengirimkan data pengguna dari Moodle ke sistem jarak jauh.';
$string['privacy:metadata:repository_picasa:searchtext'] = 'Kueri teks penelusuran pengguna repositori Picasa.';
