...
/**
 * Strings for component 'tool_task', language 'id', version '3.9'.
 *
 * @package     tool_task
 * @category    string
...
$string['disabled_help'] = 'Tugas terjadwal yang dinonaktifkan tidak dijalankan dari cron, namun masih dapat dieksekusi secara manual melalui alat CLI.';
