...
/**
 * Strings for component 'tool_uploadcourse', language 'id', version '3.9'.
 *
...
$string['cannotupdatefrontpage'] = 'Dilarang mengubah halaman depan';
...
$string['customfieldinvalid'] = 'Nama ruas tersuai profil pengguna untuk judul kursus.';
...
$string['privacy:metadata'] = 'Pengaya unggahan kursus tidak menyimpan data pribadi apa pun.';
...
$string['shortnametemplate_help'] = 'Nama singkat kursus ditampilkan di navigasi. Anda dapat menggunakan sintaks templat di sini (%f = fullname, %i = idnumber), atau masukkan nilai awal yang bertambah.';
...
$string['uploadcourses_help'] = 'Kursus dapat diunggah melalui berkas teks. Format berkas harus sebagai berikut:

* Setiap baris file berisi satu rekaman
* Setiap rekaman adalah serangkaian data yang dipisahkan dengan koma (atau pembatas lainnya)
* Rekaman pertama berisi daftar nama ruas yang menentukan format berkas lainnya
* Nama ruas yang diperlukan adalah nama pendek, nama lengkap, dan kategori';
$string['uploadcoursespreview'] = 'Unggah pratinjau kursus';
$string['uploadcoursesresult'] = 'Unggah hasil kursus';
