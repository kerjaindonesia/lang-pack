...
/**
 * Strings for component 'tool_usertours', language 'id', version '3.9'.
 *
...
$string['content_help'] = 'Konten yang menjelaskan langkah dapat ditambahkan sebagai teks biasa, diapit dalam label multibahasa (untuk digunakan dengan filter konten multibahasa) jika diperlukan. Atau, ID string bahasa dapat dimasukkan dalam pengidentifikasi format, komponen (tanpa tanda kurung atau spasi setelah koma).';
...
$string['filter_category_help'] = 'Tampilkan tur di halaman yang terkait dengan kursus dalam kategori yang dipilih.';
$string['filter_course'] = 'Kursus';
$string['filter_course_help'] = 'Tampilkan tur di halaman yang terkait dengan kursus yang dipilih.';
...
$string['left'] = 'Kiri';
$string['modifyshippedtourwarning'] = 'Ini adalah tur pengguna yang dikirimkan bersama Moodle. Modifikasi apa pun yang Anda buat dapat dikesampingkan selama peningkatan situs Anda berikutnya.';
...
$string['target_selector_targetvalue_help'] = 'Pemilih CSS dapat digunakan untuk menargetkan hampir semua elemen di halaman. Pemilih yang sesuai dapat dengan mudah ditemukan menggunakan alat pengembang untuk browser web Anda.';
...
$string['title'] = 'Judul';
$string['title_help'] = 'Judul langkah dapat ditambahkan sebagai teks biasa, diapit dalam tag multilang (untuk digunakan dengan filter konten multi-bahasa) jika diperlukan.

Atau, ID string bahasa dapat dimasukkan dalam pengidentifikasi format,komponen (tanpa tanda kurung atau spasi setelah koma).';
$string['tour1_content_addingblocks'] = 'Faktanya, pikirkan baik-baik tentang memasukkan blok apa pun di halaman Anda. Blok tidak ditampilkan di aplikasi Moodle, jadi sebagai aturan umum, jauh lebih baik untuk memastikan situs Anda berfungsi dengan baik tanpa blok.';
...
$string['tour1_content_customisation'] = 'Untuk menyesuaikan tampilan situs Anda dan halaman depan, gunakan menu setelan di sudut header ini. Coba aktifkan pengeditan sekarang.';
$string['tour1_content_end'] = 'Ini adalah akhir dari tur pengguna Anda. Itu tidak akan ditampilkan lagi kecuali Anda mengatur ulang menggunakan tautan di footer. Sebagai admin, Anda juga dapat membuat tur sendiri seperti ini!';
...
$string['tour3_content_displayoptions'] = 'Kursus dapat diurutkan berdasarkan nama kursus, nama singkat kursus atau tanggal akses terakhir.

Anda juga dapat memilih untuk menampilkan kursus dalam daftar, dengan informasi ringkasan, atau tampilan \'kartu\' bawaan.';
...
$string['tour4_content_groupconvo'] = 'Jika Anda adalah anggota grup dengan pesan grup yang diaktifkan, Anda akan melihat percakapan grup di sini.

Percakapan grup kursus memungkinkan Anda untuk berinteraksi dengan orang lain di grup Anda di lokasi yang pribadi dan nyaman.';
...
$string['tour4_content_settings'] = 'Anda dapat mengakses setelan olah pesan Anda melalui ikon roda gigi. Pengaturan privasi baru memungkinkan Anda membatasi siapa yang dapat mengirimi Anda pesan.';
...
$string['tour4_title_icon'] = 'Olahpesan';
$string['tour4_title_messaging'] = 'Antarmuka olah pesan baru';
$string['tour4_title_settings'] = 'Pengaturan olahpesan';
