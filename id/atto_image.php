...
/**
 * Strings for component 'atto_image', language 'id', version '3.9'.
 *
 * @package     atto_image
 * @category    string
...
$string['createimage'] = 'Sisip gambar';
$string['customstyle'] = 'Gaya tersuai';
...
$string['pluginname'] = 'Sisip atau edit gambar';
...
$string['privacy:metadata'] = 'Pengaya atto_image tidak menyimpan data pribadi apa pun.';
$string['saveimage'] = 'Simpan gambar';
$string['size'] = 'Ukuran';
$string['uploading'] = 'Mengunggah, tunggu...';
$string['width'] = 'Lebar';
