...
/**
 * Strings for component 'workshop', language 'id', version '3.9'.
 *
 * @package     workshop
 * @category    string
...
$string['areainstructauthors'] = 'Instruksi untuk pengumpulan';
$string['areainstructreviewers'] = 'Instruksi untuk penilaian';
...
$string['assessedsubmission'] = 'Pengumpulan yang dinilai';
...
$string['assessmentsettings'] = 'Pengaturan penilaian';
...
$string['assessmentweight'] = 'Berat penilaian';
$string['assignedassessments'] = 'Kiriman yang ditugaskan untuk dinilai';
$string['assignedassessmentsnone'] = 'Anda tidak memiliki pengajuan yang ditugaskan untuk menilai';
...
$string['createsubmission'] = 'Tambahkan pengumpulan';
...
$string['deletesubmission'] = 'Hapus pengumpulan';
...
$string['editsubmission'] = 'Ubah pengumpulan';
...
$string['feedbackauthor'] = 'Masukan untuk penulis';
$string['feedbackauthorattachment'] = 'Lampiran';
$string['feedbackby'] = 'Masukan oleh {$a}';
$string['feedbackreviewer'] = 'Masukan untuk peninjau';
...
$string['gradecalculated'] = 'Nilai yang dihitung untuk pengumpulan';
$string['gradedecimals'] = 'Digit desimal pada nilai';
$string['gradegivento'] = '&gt;';
$string['gradeinfo'] = 'Nilai: {$a->received} of {$a->max}';
$string['gradeitemassessment'] = '{$a->workshopname} (penilaian)';
$string['gradeitemsubmission'] = '{$a->workshopname} (pengajuan)';
$string['gradeover'] = 'Batalkan nilai untuk pengumpulan';
$string['gradereceivedfrom'] = '&lt;';
$string['gradesreport'] = 'Laporan nilai';
...
$string['indicator:cognitivedepthdef_help'] = 'Peserta telah mencapai persentase keterlibatan kognitif yang ditawarkan oleh aktivitas Lokakarya selama interval analisis ini (Levels = Tidak ada tampilan, Lihat, Ajukan, Lihat umpan balik, Komentari umpan balik, Ajukan ulang setelah melihat umpan balik)';
...
$string['modulename_help'] = 'Modul aktivitas lokakarya memungkinkan pengumpulan, ulasan dan penilaian sejawat siswa. Siswa dapat mengirimkan konten digital (berkas), seperti dokumen atau spreadsheet yang diproses dengan kata dan juga dapat mengetik teks secara langsung ke dalam bidang menggunakan editor teks. Kiriman dinilai menggunakan formulir penilaian multi-kriteria yang ditentukan oleh pengajar. Proses penilaian sejawat dan pemahaman formulir penilaian dapat dipraktikkan terlebih dahulu dengan contoh penyampaian yang diberikan oleh guru, disertai dengan penilaian acuan. Siswa diberi kesempatan untuk menilai satu atau lebih ajuan rekan-rekan mereka. Ajuan dan pengulas mungkin anonim jika diperlukan. Siswa memperoleh dua nilai dalam kegiatan lokakarya - nilai untuk ajuan mereka dan nilai untuk penilaian mereka atas ajuan rekan-rekan mereka. Kedua nilai tersebut dicatat dalam buku nilai.';
...
$string['nogradeyet'] = 'Belum ada nilai';
$string['nosubmissionfound'] = 'Tidak ada kiriman yang ditemukan untuk pengguna ini';
$string['nosubmissions'] = 'Belum ada pengajuan di lokakarya ini';
...
$string['noyoursubmission'] = 'Anda belum mengumpulkan tugas';
$string['nullgrade'] = '-';
$string['overallfeedback'] = 'Masukan keseluruhan';
...
$string['publishedsubmissions'] = 'Kiriman yang diumumkan';
$string['publishsubmission'] = 'Mengumumkan kiriman';
$string['publishsubmission_help'] = 'Kiriman yang diterbitkan tersedia untuk yang lain ketika lokakarya ditutup.';
...
$string['strategy_help'] = 'Strategi penilaian menentukan bentuk penilaian yang digunakan dan metode pengajuan penilaian. Ada 4 opsi: * Penilaian akumulatif - Komentar dan nilai diberikan mengenai aspek tertentu * Komentar - Komentar diberikan mengenai aspek tertentu tetapi tidak ada nilai yang dapat diberikan * Jumlah kesalahan - Komentar dan penilaian ya/tidak diberikan terkait pernyataan yang ditentukan * Rubrik - Penilaian tingkat diberikan mengenai kriteria yang ditentukan';
...
$string['submissioncontent'] = 'Konten penyerahan';
$string['submissiondeleteconfirm'] = 'Anda yakin ingin menghapus kiriman berikut?';
...
$string['submissionsreport'] = 'Laporan pengiriman lokakarya';
...
$string['switchphase10'] = 'Beralih ke fase pengaturan';
$string['switchphase10info'] = 'Anda akan mengalihkan lokakarya ke <strong>Fase Penyiapan</strong>. Pada fase ini, pengguna tidak dapat mengubah ajuan atau penilaian mereka. Guru dapat menggunakan fase ini untuk mengubah setelan lokakarya, memodifikasi strategi penilaian atau mengubah formulir penilaian.';
$string['switchphase20'] = 'Beralih ke fase pengiriman';
...
$string['usepeerassessment_help'] = 'Jika diaktifkan, pengguna dapat dialokasikan ajuan dari pengguna lain untuk dinilai dan akan menerima nilai untuk penilaian selain nilai untuk ajuan mereka sendiri.';
...
$string['useselfassessment_help'] = 'Jika diaktifkan, pengguna dapat mengalokasikan kiriman mereka sendiri untuk dinilai dan akan menerima nilai untuk penilaian selain nilai untuk kiriman mereka.';
$string['viewworkshopsummary'] = 'Lihat ringkasan lokakarya';
$string['weightinfo'] = 'Berat: {$a}';
...
$string['yoursubmission'] = 'Pengumpulan Anda';
